...
struct ParticleList
{
	...
	// pressure accessor
	const /*glm::vec3&*/float& press(unsigned int n) const
    {
        assert(n < m_size);
        return m_press[n];
    }
    /*glm::vec3&*/float& press(unsigned int n)
    {
        assert(n < m_size);
        return m_press[n];
    }
	...
	//stress accessor
	 const /*glm::vec3&*/float& stress(unsigned int n) const
    {
        assert(n < m_size);
        return m_stress[n];
    }
    /*glm::vec3&*/float& stress(unsigned int n)
    {
        assert(n < m_size);
        return m_stress[n];
    }
	...
	//corrective pressure accessor
	 const /*glm::vec3&*/float& corrective_press(unsigned int n) const
    {
        assert(n < m_size);
        return m_corrective_press[n];
    }
    /*glm::vec3&*/float& corrective_press(unsigned int n)
    {
        assert(n < m_size);
        return m_corrective_press[n];
    }
	...
	//corrective stress accessor
	 const /*glm::vec3&*/float& corrective_stress(unsigned int n) const
    {
        assert(n < m_size);
        return m_corrective_stress[n];
    }
    /*glm::vec3&*/float& corrective_stress(unsigned int n)
    {
        assert(n < m_size);
        return m_corrective_stress[n];
    }
...
protected:
	...
	//particle type: 0->boundary 1->granular 2->partially wet (not implemented yet) 3->wet (not implemented yet) 4->water (implemented separately need to combine)
