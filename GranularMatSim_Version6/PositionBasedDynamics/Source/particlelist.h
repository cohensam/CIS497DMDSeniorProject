...
protected:
	...
	//particle type: 0->boundary 1->granular low res 2->partially wet (not implemented yet) 3->wet (not implemented yet) 4->water (implemented separately need to combine)
	//5->granular high res
