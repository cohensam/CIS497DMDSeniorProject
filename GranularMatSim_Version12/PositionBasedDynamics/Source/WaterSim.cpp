	...
	for (int k = 0; k < 3; k++) {
		for (int i = 0; i < particleList.size(); i++) {
			...
			if (particleList.type(i) != 4) {
				...
				particleList.predicted_vel(i) = particleList.vel(i) + dt * (particleList.grav(i) + particleList.disc(i) + particleList.fricoh(i));// + particleList.press_force(i));// + particleList.fricoh(i) + particleList.disc(i));// + particleList.press_force(i));
					//particleList.visc(i));
			} else {
